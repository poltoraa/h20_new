 ...
 */
(function(d, v, q) {
    function y() { z = v[s](function() { o.each(function() {
        var a = d(this),
            b = a.width(),
            c = a.height(),
            f = d.data(this, u);
    ...
    var B = function(a, b) {
        ...
        if (1 < c.defs.total && "bar" != c.defs.timer) {
            ...
            c.R = k / 2;
            var n = { stroke: b.timerBg, "stroke-width": h + 2 * g },
                D = { stroke: b.timerColor, "stroke-width": h, "stroke-linecap": "round" },
        ...
        "bar" == c.defs.timer ? (c.iviewTimer.css({ opacity: b.timerOpacity, width: k, height: h, border: b.timerBarStroke + "px " + b.timerBarStrokeColor + " " + b.timerBarStrokeStyle, padding: g, background: b.timerBg }), c.barTimer.css({
            width: 0,
            height: h,
        ...
        c.setTimerPosition();
        new r(c.defs.images, function(a) { a = a * 10;
            e.stop().animate({ width: a + "%" }) }, function() { e.stop().animate({ width: "100%" }, function() { f.remove();
            c.startSlider();
            b.onAfterLoad.call(this) }) });
        c.sliderContent.bind("swipeleft", function() {
            if (c.defs.lock) return false;
            c.cleanTimer();
            c.goTo("next") }).bind("swiperight", function() {
            if (c.defs.lock) return false;
            c.cleanTimer();
        ...
        b.keyboardNav && d(document).bind("keyup.iView", function(a) {
            ...
            if (a.keyCode == "39") {
                ...
                c.cleanTimer();
                c.goTo("next") } });
        c.iviewTimer.live("click", function() { c.iviewTimer.hasClass("paused") ? c.playSlider() : c.stopSlider() });
        c.sliderContent.bind("iView:pause", function() { c.stopSlider() });
        c.sliderContent.bind("iView:play", function() { c.playSlider() });
        ...
        c.sliderContent.bind("resize", function() {
            ...
            if (c.defs.width != tW) {
                ...
                c.slider.css({ "-webkit-transform-origin": "0 0", "-moz-transform-origin": "0 0", "-o-transform-origin": "0 0", "-ms-transform-origin": "0 0", "transform-origin": "0 0", "-webkit-transform": "scale(" + a + ")", "-moz-transform": "scale(" + a + ")", "-o-transform": "scale(" + a + ")", "-ms-transform": "scale(" + a + ")", transform: "scale(" + a + ")" });
                t.css({ height: b });
                c.defs.width = tW;
                c.setTimerPosition() }
        });
        d(".iview-video", c.slider).click(function(a) {
            ...
            if (!d(a.target).hasClass("iview-video-close") && !d(a.target).hasClass("iview-caption") && !d(a.target).parents().hasClass("iview-caption")) { b.show().animate({ top: 0 }, 1E3, "easeOutBounce");
        ...
        d(".iview-video-close", c.slider).click(function() {
            ...
            a.animate({
                top: "-" + c.defs.height +
                "px"
            }, 1E3, "easeOutBounce", function() { a.hide();
    ...
    B.prototype = {
        ...
        startSlider: function() {
            ...
            a.options.directionNav && (a.sliderContent.append('<div class="iview-directionNav"><a class="iview-prevNav" title="' + a.options.previousLabel + '">' + a.options.previousLabel + '</a><a class="iview-nextNav" title="' + a.options.nextLabel + '">' + a.options.nextLabel + "</a></div>"), d(".iview-directionNav", a.sliderContent).css({ opacity: a.options.directionNavHoverOpacity }),
                a.sliderContent.hover(function() { d(".iview-directionNav", a.sliderContent).stop().animate({ opacity: 1 }, 300) }, function() { d(".iview-directionNav", a.sliderContent).stop().animate({ opacity: a.options.directionNavHoverOpacity }, 300) }), d("a.iview-prevNav", a.sliderContent).live("click", function() {
                if (a.defs.lock) return false;
                a.cleanTimer();
                a.defs.slide = a.defs.slide - 2;
                a.goTo("prev") }), d("a.iview-nextNav", a.sliderContent).live("click", function() {
                if (a.defs.lock) return false;
                a.cleanTimer();
                a.goTo("next") }));
            if (a.options.controlNav) {
                ...
                a.sliderContent.hover(function() { d(".iview-controlNav", a.sliderContent).stop().animate({ opacity: 1 }, 300);
                    a.sliderContent.addClass("iview-hover") }, function() { d(".iview-controlNav", a.sliderContent).stop().animate({ opacity: a.options.controlNavHoverOpacity }, 300);
                ...
                d(".iview-controlNav a.iview-control", a.sliderContent).hover(function() {
                    ...
                    g = setTimeout(function() { b.animate({ opacity: 0 }, 300, function() { b.hide() }) }, 200) })
            }
            a.sliderContent.bind("mouseover.iView mousemove.iView", function() { a.options.pauseOnHover && !a.defs.paused && a.cleanTimer();
                a.sliderContent.addClass("iview-hover") }).bind("mouseout.iView", function() { a.options.pauseOnHover && (!a.defs.paused && a.timer == null && a.pieDegree <= 359 && a.options.autoAdvance) && a.setTimer();
                a.sliderContent.removeClass("iview-hover") })
        },
        setCaption: function() {
            var a = this,
            ...
            d(".iview-caption", b).each(function() {
                ...
                setTimeout(function() { b.animate({ opacity: a.options.captionOpacity, top: i, left: h, width: j, height: l }, g, k, function() {}) }, c);
                setTimeout(function() {
                    m.animate({
        ...
        processTimer: function() {
            if ("360bar" == this.defs.timer) {
                ...
                this.timerPath.attr({ arc: [a, this.R] }) } else "pie" == this.defs.timer ? (a = 0 == this.pieDegree ? 0 : this.pieDegree + 0.9, this.pieTimer.attr({ segment: [a, this.R] })) : this.barTimer.css({ width: 100 * (this.pieDegree / 360) + "%" });
            this.pieDegree += 3 },
        transitionEnd: function(a) {
            ...
            a.processTimer();
            a.setCaption(a.options);
            null == a.timer && !a.defs.paused && (a.timer = setInterval(function() { a.timerCall(a) }, a.defs.time / 120))
        },
        addStrips: function(a, b) {
            for (var b = b ? b : this.options, c = 0; c < b.strips; c++) {
                ...
                g = d('<div class="iview-strip"></div>').css({ width: f, height: e, top: k, left: h, background: 'url("' + this.defs.image.data("iview:image") + '") no-repeat ' + g, opacity: 0 });
        ...
        addBlocks: function() {
            for (var a = Math.round(this.slider.width() /
                ...
                for (var f = 0; f < this.options.blockCols; f++) {
                    ...
                    e = d('<div class="iview-block"></div>').css({ width: a + "px", height: b + "px", top: c * b + "px", left: f * a + "px", background: 'url("' + this.defs.image.data("iview:image") + '") no-repeat ' + e, opacity: 0 });
            ...
            switch (a) {
                ...
                case "strip-up-left":
                    ...
                    e.each(function() {
                        ...
                        setTimeout(function() { a.animate({ height: "100%", opacity: "1.0" }, b.options.animationSpeed, b.defs.easing, function() { f == b.options.strips - 1 && b.transitionEnd(b);
                            f++ }) }, 100 + c);
                        c += 50 });
                    break;
                case "strip-down":
                ...
                case "strip-left-right-down":
                    ...
                    e.each(function() {
                        ...
                        setTimeout(function() { a.animate({ width: "100%", opacity: "1.0" }, b.options.animationSpeed, b.defs.easing, function() { g == b.options.strips - 1 && b.transitionEnd(b);
                            g++ }) }, 100 + c);
                        c += 50
                    });
                    break;
                ...
                case "strip-up-down-left":
                    ...
                    e.each(function() {
                        ...
                        setTimeout(function() { a.animate({ height: "100%", opacity: "1.0" }, b.options.animationSpeed, b.defs.easing, function() { g == b.options.strips - 1 && b.transitionEnd(b);
                            g++ }) }, 100 + c);
                        c += 50
                    });
                    break;
                ...
                case "bottom-curtain":
                    ...
                    e.each(function() {
                        var e = d(this),
                            g = e.width(),
                            h = e.height();
                        "left-curtain" == a || "right-curtain" == a ? e.css({ top: "0px", height: "100%", width: "0px" }) : e.css({ left: "0px", height: "0px", width: "100%" });
                        setTimeout(function() {
                            "left-curtain" == a || "right-curtain" == a ? e.animate({ width: g, opacity: "1.0" }, b.options.animationSpeed, b.defs.easing, function() { f == b.options.strips - 1 && b.transitionEnd(b);
                                f++ }) : e.animate({ height: h, opacity: "1.0" }, b.options.animationSpeed, b.defs.easing, function() {
                ...
                case "strip-bottom-fade":
                    ...
                    e.each(function() {
                        var e = d(this),
                            g = e.width(),
                            h = e.height();
                        "strip-left-fade" == a || "strip-right-fade" == a ? e.css({ top: "0px", height: "100%", width: g }) : e.css({ left: "0px", height: h, width: "100%" });
                        setTimeout(function() {
                ...
                case "slide-in-down":
                    ...
                    e.animate({ top: "0px", opacity: 1 }, 2 * b.options.animationSpeed, b.defs.easing, function() { b.transitionEnd(b) });
                    break;
                case "zigzag-top":
                case "zigzag-bottom":
                ...
                case "zigzag-drop-bottom":
                    ...
                    for (var h = b.options.blockCols * b.options.blockRows, c = 0, i = [], e = d(".iview-block", b.slider), j = 0; j < b.options.blockRows; j++) {
                        ...
                        if (1 == j % 2)
                            ...
                            for (n = k; n < l; n++) i.push(d(e[n])) }("zigzag-bottom" == a || "zigzag-grow-bottom" == a || "zigzag-drop-bottom" == a) && i.reverse();
                    e.each(function(e) {
                        var f = d(i[e]),
                            g = f.height(),
                            j = f.width(),
                ...
                case "block-expand-reverse":
                    ...
                    for (n = 0; n < 2 * b.options.blockCols; n++) {
                        ...
                        function() {
                            ...
                            setTimeout(function() { e.animate({ opacity: "1", width: g, height: k }, b.options.animationSpeed / 1.3, b.defs.easing, function() { f == h - 1 && b.transitionEnd(b);
                                f++ }) }, 100 + c) }(), p--;
                        c += 100
                    }
                    break;
                ...
                case "block-drop-random":
                    ...
                    e.each(function(e) {
                        ...
                        setTimeout(function() { f.animate({ top: i, opacity: "1", height: g, width: k }, b.options.animationSpeed, b.defs.easing, function() { e == h - 1 && b.transitionEnd(b) }) }, 100 + c);
                        c += 20
                    });
                    break;
                default:
                    opts = { strips: 1 }, b.addStrips(!1, opts), e = d(".iview-strip:first", b.slider), e.css({ height: "100%", width: b.defs.width }), "slide-in-right" == a ? e.css({
                        height: "100%",
                        width: b.defs.width,
                        left: b.defs.width +
                        "px",
        ...
        shuffle: function(a) {
            for (var a = a.slice(), b = a.length, c = b; c--;) {
                ...
                a[d] = e }
            return a },
        timerCall: function(a) { a.processTimer();
        ...
        playSlider: function() { null == this.timer && this.defs.paused && (this.iviewTimer.removeClass("paused").attr("title", this.options.pauseLabel), this.setTimer(), this.defs.paused = !1, this.options.onPlay.call(this)) },
        stopSlider: function() { this.iviewTimer.addClass("paused").attr("title", this.options.playLabel);
            this.cleanTimer();
            this.defs.paused = !0;
        ...
        disableSelection: function(a) { "undefined" != typeof a.onselectstart ? a.onselectstart = function() {
            return !1 } : "undefined" != typeof a.style.MozUserSelect ? a.style.MozUserSelect = "none" : "undefined" != typeof a.style.webkitUserSelect ? a.style.webkitUserSelect = "none" : "undefined" != typeof a.style.userSelect ? a.style.userSelect = "none" : a.onmousedown = function() {
            return !1 };
            a.unselectable = "on" },
        isTouch: function() {
    ...
    r.prototype = {
        ...
        OnLoad: function() { this.bLoaded = !0;
            this.oImagePreload.m_nLoaded++;
            this.oImagePreload.OnComplete() },
        OnError: function() { this.bError = !0;
            this.oImagePreload.OnComplete() },
        OnAbort: function() { this.bAbort = !0;
            this.oImagePreload.OnComplete() }
    };
        ...
        setup: function() {
            ...
            a.bind(E, function(b) {
                ...
                var f = b.originalEvent.touches ?
                    ...
                    e = { time: (new Date).getTime(), coords: [f.pageX, f.pageY], origin: d(b.target) },
                    g;
                a.bind(C, c).one(F, function() { a.unbind(C, c);
