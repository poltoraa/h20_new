...
$arTemplateParameters = array(
    "GROUP_PROPERTIES1" => array(
        "PARENT" => "FIELDS",
        "NAME" => GetMessage("GROUP_PROPERTIES1"),
        "TYPE" => "LIST",
        "MULTIPLE" => "Y",
        "VALUES" => $arProperty_LNSF,
    ),
    "GROUP_PROPERTIES2" => array(
        "PARENT" => "FIELDS",
        "NAME" => GetMessage("GROUP_PROPERTIES2"),
        "TYPE" => "LIST",
        "MULTIPLE" => "Y",
        "VALUES" => $arProperty_LNSF,
    ),
    "GROUP_PROPERTIES3" => array(
        "PARENT" => "FIELDS",
        "NAME" => GetMessage("GROUP_PROPERTIES3"),
        "TYPE" => "LIST",
        "MULTIPLE" => "Y",
        "VALUES" => $arProperty_LNSF,
    ),
    "GROUP_PROPERTIES4" => array(
        "PARENT" => "FIELDS",
        "NAME" => GetMessage("GROUP_PROPERTIES4"),
        "TYPE" => "LIST",
        "MULTIPLE" => "Y",
        "VALUES" => $arProperty_LNSF,
    )
